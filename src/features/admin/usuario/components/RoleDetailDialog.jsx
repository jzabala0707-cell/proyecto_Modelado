        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
          <div className="flex items-center gap-4 pb-4 border-b">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-xl font-bold truncate">{role.nombre}</h2>
              <p className="text-muted-foreground text-sm truncate">{role.descripcion}</p>
              <div className="mt-2">
          ...
          <div className="space-y-2">
            ...
            <div className="border rounded-lg bg-muted/20 overflow-hidden">
              <PermissionsTable
                selected={role.permisosIds ?? role.permisos_ids ?? []}
                disabled={true}
                onToggle={() => {}}
              />
            </div>
